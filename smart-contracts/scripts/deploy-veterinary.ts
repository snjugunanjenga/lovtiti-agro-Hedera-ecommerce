...
async function deployVeterinary() {
  ...
  const contractPath = path.join(__dirname, "../contracts/Veterinary.sol");
  ...
  console.log(`Veterinary contract deployed with ID: ${contractId}`);
