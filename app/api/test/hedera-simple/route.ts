...
export async function GET() {
  try {
    ...
    // Test 1: Get account balance (this verifies connection and authentication)
    ...
    // Note: getNodeAccountIds() method may not be available in all SDK versions
    const nodeAccountIds: any[] = [];
    ...
    return NextResponse.json({
      ...
      tests: {
        ...
        accountInfo: "✅ Account information retrieved successfully"
      },
      accountInfo: {
        accountId: accountId,
